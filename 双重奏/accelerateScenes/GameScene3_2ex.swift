...
import SpriteKit
import GameplayKit
class GameScene3_2ex: SKScene, SKPhysicsContactDelegate, UIGestureRecognizerDelegate
{
    //声明游戏场景中的各个属性和节点
    ...
    override public func update(_ currentTime: TimeInterval)
    {
        ...
        if (Int(timer) == 22)
        {
            levelCompleted(level: 8, isAccelerated: true)
    ...
    func die(ball: SKSpriteNode)
    {
        ...
        //创建一个新的游戏场景
        let scene = GameScene3_2ex(fileNamed: "GameScene3_2ex")
